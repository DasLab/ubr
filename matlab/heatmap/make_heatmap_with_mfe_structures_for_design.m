...
if ~exist( 'make_heatmap_with_structures_for_design', 'file' )
...
make_heatmap_with_structures_for_design( idx, r_norm, mfe_structure_map, mfe_structures,mfe_tags, pkg_sort_idx, headers, sequences, BLANK_OUT5, BLANK_OUT3, tags, create_figure_window );

fprintf( 'WARNING! make_heatmap_with_mfe_structures_for_design has been deprecated in favor of make_heatmap_with_structures_for_design in the OpenKnotScore repository at https://github.com/eternagame/OpenKnotScore\n' );
