function output_rdats_from_ubr_analysis( d, out_prefix, name, output_idx, comments, annotations, condition_comments, condition_annotations, chunk_size, signal_to_noise_cutoff, reads_cutoff);
...
for i = 1:Nconditions
    ...
    % TODO: This extra_data_annotations needs to be updated for cases where we
    %  don't have Eterna integer ids. Could use id_strings instead, or
    %  maybe full headers? Could be tricky with tabs.
    extra_data_annotations = get_extra_data_annotations_for_eterna( d.ids, d.titles, d.authors );
